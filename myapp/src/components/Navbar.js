...
class Navbar extends Component {
      static contextType = AppContext; // Access AppContext in class component
      ...
      render() {
            const { flagSignUp, firstname,flagLogin } = this.context; // Get flagSignUp and firstName from context
            console.log(flagLogin,flagSignUp);
                        ...
                        <nav>
                              ...
                              <div>
                                    <ul id="navbar" className={this.state.clicked ? "#navbar active" : "navbar"}>
                                          ...
                                          {!flagSignUp && (
                                                <li>
                                                      <NavLink to='/AccountProfile'>{firstname}</NavLink>
                                                </li>
                                          )}
