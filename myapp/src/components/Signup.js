                    ...
                    <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 grid lg:grid-cols-2 gap-8 lg:gap-16">
                        <div className="flex flex-col justify-center">
                            ...
                            <p className="mb-6 text-lg font-normal text-gray-500 lg:text-xl dark:text-gray-400">
                                Sign up now to start your journey with Flowbite and explore our wide range of rental cars.
                            </p>
                            <NavLink to="/signup" className="text-blue-600 dark:text-blue-500 hover:underline font-medium text-lg inline-flex items-center">
                                Sign Up Now
                                ...
                                <form className="mt-8 space-y-6" action="#">
                                    ...
                                    <div className="items-start">
                                        <div className="grid-class">
                                            ...
                                            <NavLink to="/forgot-password" className="forgot-password ms-auto text-sm font-medium text-blue-600 hover:underline dark:text-blue-500">Forgot Password?</NavLink>
                                        </div>
                                    </div>
                                    ...
                                    <div className="text-sm font-medium text-gray-900 dark:text-white">
                                        Already have an account? <NavLink to="/login" className="text-blue-600 hover:underline dark:text-blue-500">Log in here</NavLink>
                                    </div>
                                </form>
                            </div>
                        </div>
